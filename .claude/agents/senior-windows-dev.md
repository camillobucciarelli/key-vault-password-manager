---
name: senior-windows-dev
description: Senior Windows developer per integrazioni native Windows, C++/Win32, CMake e packaging desktop. Usa per implementare o correggere codice in windows/, desktop/ e native messaging bridge Windows.
