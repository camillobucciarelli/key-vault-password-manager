---
name: senior-flutter-dev
description: Senior Flutter/Dart developer per implementare feature, bug fix e refactor nell'app Flutter. Usa per lavoro su BLoC, use case, repository, service, coordinators e UI in lib/features/password_manager/.
