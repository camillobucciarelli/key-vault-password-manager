...
- [ ] **A001 — Canonical host lock.** Create `tool/app_icon_host.lock.json` with
...
- [ ] **A002 — Provision bootstrap.** Create `tool/bootstrap_app_icon_host.sh`.
...
- [ ] **A003 — Generator CLI and path safety.** Create
      ...
      mode.
- [ ] **A004 — Master/record validation.** Pin both source hashes; parse exact XML
...
- [ ] **A005 — Size-aware independent geometry oracle.** Implement
...
- [ ] **A006 — Monochrome derivative and core rasters.** Derive monochrome SVG by
...
- [ ] **A007 — App and extension bases.** Generate RGB `app-192.png`,
      `app-512.png`, and `ext-16/32/48/128.png` from full master. No alpha, extra
      padding, or corner rounding.
- [ ] **A008 — Six state assets only.** Generate locked/no-host at 16/32/48. Base
...
- [ ] **A009 — Raster safety checks.** Build in-memory component/union coverage
...
- [ ] **A010 — Review sheet and manifest.** Generate exact 1600×1200 RGB sheet
...
- [ ] **A011 — Stdlib generator tests.** Create
...
- [ ] **A012 — Inventory acceptance.** Generate into a canonicalized temporary
      ...
      manifest coverage.
- [ ] **A013 — Canonical determinism.** Set
...
- [ ] **A014 — Review evidence and initial copy.** Generate a separate fresh
