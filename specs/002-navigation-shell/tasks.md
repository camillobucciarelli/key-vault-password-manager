...
- [x] **T1** Snapshot title/body/action literals for the exact 19 FR-7 calls into
...
- [x] **T4** Rework `vault_shell.part.dart` with private tab-bar/rail/layout
...
- [x] **T7** Migrate Vault entry detail/editor, generator, metadata, attachments
...
- [ ] **T10** Migrate database settings, master-password, key-file and CSV/import
      ...
      and analyze.
- [x] **T11** Move confirmation sheet content from `vault_dialogs.part.dart` to
...
- [x] **T13** Add exact four shell goldens using spec-001 harness and review diffs.
